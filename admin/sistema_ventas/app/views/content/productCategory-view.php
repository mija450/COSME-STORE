        ...
        <div class="column pb-6">
            <?php
                ...
                if ($categoria->rowCount() > 0) {
                    ...
                    // Comprobar si $url[2] está definido antes de usarlo
                    $pagina = isset($url[2]) ? $url[2] : 1; // Asigna un valor por defecto si no está definido
                    echo $insProducto->listarProductoControlador($pagina, 10, $url[0], "", $url[1]);
                } else {
                    echo '
