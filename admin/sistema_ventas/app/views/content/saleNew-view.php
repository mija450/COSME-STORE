<div class="container is-fluid mb-6">
    <h1 class="title has-text-centered">Ventas</h1>
    <h2 class="subtitle has-text-centered"><i class="fas fa-cart-plus fa-fw"></i> &nbsp; Nueva venta</h2>
</div>
...
<div class="columns is-centered">
    <div class="column is-three-quarters">
                ...
                <div class="column">
                    <div class="field is-grouped">
                        <p class="control is-expanded">
                            <input class="input" type="text" pattern="[a-zA-Z0-9- ]{1,70}" maxlength="70" autofocus placeholder="Código de barras" id="sale-barcode-input">
                        </p>
                        <a class="control">
        ...
        <?php if (isset($_SESSION['alerta_producto_agregado']) && $_SESSION['alerta_producto_agregado'] != "") { ?>
            <div class="notification is-success is-light">
                <?php echo $_SESSION['alerta_producto_agregado']; ?>
            </div>
        <?php unset($_SESSION['alerta_producto_agregado']); } ?>
                    ...
                    <div class="columns is-centered">
                        <div class="column has-text-centered">
                            <button type="button" class="button is-link is-light" onclick="print_ticket('<?php echo APP_URL . "app/pdf/ticket.php?code=" . $_SESSION['venta_codigo_factura']; ?>')">
                                <i class="fas fa-receipt fa-2x"></i> &nbsp; Imprimir ticket de venta
                            </button>
                        </div>
                        <div class="column has-text-centered">
                            <button type="button" class="button is-link is-light" onclick="print_invoice('<?php echo APP_URL . "app/pdf/invoice.php?code=" . $_SESSION['venta_codigo_factura']; ?>')">
                                <i class="fas fa-file-invoice-dollar fa-2x"></i> &nbsp; Imprimir factura de venta
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="table-container">
            <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
                ...
                <tbody>
                    <?php if (isset($_SESSION['datos_producto_venta']) && count($_SESSION['datos_producto_venta']) >= 1) {
    ...
    <div class="column is-one-quarter has-text-centered">
        ...
        <label>Cliente</label>
        <?php if (isset($_SESSION['datos_cliente_venta']) && count($_SESSION['datos_cliente_venta']) >= 1 && $_SESSION['datos_cliente_venta']['cliente_id'] != 1) { ?>
            <div class="field has-addons mb-5">
                ...
                <div class="control">
                    <a class="button is-danger" title="Remover cliente" id="btn_remove_client" onclick="remover_cliente(<?php echo $_SESSION['datos_cliente_venta']['cliente_id']; ?>)">
        ...
        <h4 class="subtitle is-5 has-text-weight-bold mb-5">
