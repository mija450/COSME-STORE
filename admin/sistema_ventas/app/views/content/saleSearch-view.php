...
<div class="container pb-6 pt-6">
    ...
    <div class="columns">
        <div class="column">
            <form class="has-text-centered mt-6 mb-6 FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/buscadorAjax.php" method="POST" autocomplete="off">
                ...
                <input type="hidden" name="modulo_url" value="<?php echo $url[0]; ?>">
                <p><i class="fas fa-search fa-fw"></i> &nbsp; Estás buscando por código <strong>“<?php echo $_SESSION[$url[0]]; ?>”</strong></p>
                <br>
    ...
    <?php
            // Aquí puedes agregar depuración si es necesario
            // var_dump(get_class_methods($insVenta));

            // Asegúrate de que la llamada al método sea correcta
