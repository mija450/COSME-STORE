...
<div class="container pb-6 pt-6">
    <?php
    include "./app/views/inc/btn_back.php"; // Botón para regresar
    $id = $insLogin->limpiarCadena($url[1]); // Limpiar el ID de entrada
    ...
    <div class="columns is-flex is-justify-content-center">
        ...
        <h2 class="title has-text-centered"><?php echo htmlspecialchars($datos['producto_nombre']) . " (Stock: " . $datos['producto_stock'] . ")"; ?></h2>
        ...
        <div class="columns">
            <div class="column">
                <div class="control">
                    ...
                    <input class="input" type="text" name="producto_codigo" value="<?php echo htmlspecialchars($datos['producto_codigo']); ?>" pattern="[a-zA-Z0-9- ]{1,77}" maxlength="77" required>
                </div>
            </div>
            <div class="column">
                <div class="control">
                    <label>Nombre <?php echo CAMPO_OBLIGATORIO; ?></label>
                    <input class="input" type="text" name="producto_nombre" value="<?php echo htmlspecialchars($datos['producto_nombre']); ?>" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,100}" maxlength="100" required>
                </div>
            </div>
        </div>
        <div class="columns">
            <div class="column">
                <div class="control">
                    ...
                    <input class="input" type="text" name="producto_precio_compra" value="<?php echo htmlspecialchars($datos['producto_precio_compra']); ?>" pattern="[0-9.]{1,25}" maxlength="25" required>
                </div>
            </div>
            <div class="column">
                <div class="control">
                    <label>Precio de venta <?php echo CAMPO_OBLIGATORIO; ?></label>
                    <input class="input" type="text" name="producto_precio_venta" value="<?php echo htmlspecialchars($datos['producto_precio_venta']); ?>" pattern="[0-9.]{1,25}" maxlength="25" required>
                </div>
            </div>
            <div class="column">
                <div class="control">
                    <label>Stock o existencias <?php echo CAMPO_OBLIGATORIO; ?></label>
                    <input class="input" type="text" name="producto_stock" value="<?php echo htmlspecialchars($datos['producto_stock']); ?>" pattern="[0-9]{1,22}" maxlength="22" required>
                </div>
            </div>
        </div>
        <div class="columns">
            <div class="column">
                <div class="control">
                    <label>Marca</label>
                    <input class="input" type="text" name="producto_marca" value="<?php echo htmlspecialchars($datos['producto_marca']); ?>" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,30}" maxlength="30">
                </div>
            </div>
            <div class="column">
                <div class="control">
                    <label>Modelo</label>
                    <input class="input" type="text" name="producto_modelo" value="<?php echo htmlspecialchars($datos['producto_modelo']); ?>" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,30}" maxlength="30">
                </div>
            </div>
            <div class="column">
                <div class="control">
    ...
    <?php
        ...
        include "./app/views/inc/error_alert.php"; // Mostrar error si no se encuentra el producto
    }
    ?>
</div>